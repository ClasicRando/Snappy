 ...
 * [RowParserCache] using [RowParserCache.loadCache]. This annotation can be applied to classes
 * that:
 ...
 *
 * During a call to [RowParserCache.loadCache], metadata will be collected on classes with this
 * annotation to properly cache the [RowParser] for usage within the application lifetime.
 */
